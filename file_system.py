import random
sia = ["Whispers in the Shadows",
       "The Enigma of Elmwood Manor",
       "Midnight Murmurs",
       "Echoes of Deception",
       "The Puzzle of the Missing Heirloom",
       "Fogbound Secrets",
       "The Cryptic Code",
       "Shattered Illusions",
       "The Case of the Vanishing Bride",
       "Secrets of the Forgotten Chamber",
       ...
       "Quest for the Sacred Artifact",
       "The Forbidden Jungle",
       "Echoes of the Amazon",
       "Into the Wild",
       "The Treasure of El Dorado",
       "Secrets of the Sahara",
       "Echoes of Greatness: The Life of a Legend",
       "In the Footsteps of History",
       "A Journey Through Time: The Memoirs of a Pioneer",
       "The Courage Within: A True Story",
       "Voices of Resilience: A Biography",
       "Echoes of Triumph: A Life Well Lived",
       "The Path to Greatness: A Biography",
       "In Pursuit of Excellence: The Story of a Visionary",
       "Against All Odds: A Biography",
       "From Adversity to Achievement: The Story of a Survivor"]
